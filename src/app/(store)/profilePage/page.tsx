    ...
    return (
        <div className="flex justify-center mt-15">
            <div className="mx-7 mt-3">
                ...
                <div className="my-5">
                    <button type="button" className="font-semibold"> Manage Account</button>
                ...
                <div >
                    <button type="button" className="font-semibold"> My Orders </button>
                    <ul className="ml-3 mt-2 font-light text-xs text-gray-500">
                        <li>
            ...
            <div className="flex-col m-2.5">
                    ...
                    <div>
                        <Card className="flex h-full w-75">
                            <CardHeader className="flex items-baseline mt-2">
                                <CardTitle className="whitespace-nowrap">Personal Details</CardTitle>
                                <button type="button" className="text-xs text-gray-400 hover:text-blue-700">EDIT
                                </button>
                            </CardHeader>
                        ...
                        <Card className="h-full w-150">
                            ...
                            <div className="flex space-x-8 mt-4">
                                <div className="flex-1">
                                    <CardDescription className="font-medium mt-[-13] mb-3 ml-6">DEFAULT SHIPPING
                                ...
                                <div className="flex-1">
                                    <CardDescription className="font-medium mt-[-13] mb-3 ml-6">DEFAULT BILLING
                                        ADDRESS</CardDescription>
                                    <CardContent>
                                        <div className="my-1 font-bold text-lg">Name</div>
                                        Address 1 <br/>
                ...
                <div className="mt-5">
                    <Card className="flex ">
                        ...
                        <CardContent className="grid-rows-3 grid-cols-5">
                        </CardContent>
                        <CardFooter></CardFooter>
                    </Card>
                </div>
