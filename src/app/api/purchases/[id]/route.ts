import {getPurchaseProducts, deletePurchaseProducts} from "@/features/purchase-products/services/crud"
import { validateIdParam } from "@/lib/utils";

/**
 * GET /api/purchase-products/[id]
 *
...
export async function GET(req: Request, { params }: {params: {id: string } }) {
  ...
  if (id instanceof Response) {
    ...
    return getPurchaseProducts(numId);
  }
}

/**
 * DELETE /api/purchase-products/[id]
 *
...
export async function DELETE(req: Request, { params }: {params: {id: string } }) {
  ...
  if (id instanceof Response) {
    ...
    const numId = Number(id);
    return deletePurchaseProducts(numId);
  }
}